 ...
 */
@Repository
public interface VendorTaskRepository extends MyJpaRepository<VendorContentTask, String>, JpaSpecificationExecutor<VendorContentTask> {
    ...
    List<VendorContentTask> findByJobIdIn(List<String> jobIds);
